...
public class GetRequest09 extends TestBase{
    ...
    public void get01() {
        ...
        */
		...
		//24 tane isci oldugunu verify edinizi
		softAssert.assertEquals(json.getList("data.id").size(),24,"24 isci yok");
	
		
		//7 inci iscinin maasinin 137500 oldugunu verify ediniz
		softAssert.assertEquals(json.getString("data[6].employee_salary"),"137500","maas istenilen gibi degil");
		softAssert.assertAll();
